...
class TradeReconciler:
    ...
    def _generate_enhanced_clearing(self, clearing_df: pd.DataFrame, broker_df: pd.DataFrame, matched: List[Dict]) -> str:
        ...
        try:
            ...
            # Remove all internal/duplicate columns that were added during parsing
            ...
            # Get original clearing columns (excluding internal ones)
            original_cols = [col for col in clearing_df.columns if col not in internal_cols and col != 'Bloomberg Ticker']
